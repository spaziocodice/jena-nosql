...
public interface MessageCatalog {
	...
	String _00032_CONFIGURATION_FILE_NOT_FOUND = PREFIX + "-00032> : Configuration strategy with system property %s indicates a file (%s) that cannot be found.";
	...
	String _00035_CONFIGURATION_DIR_FILE_CANNOT_BE_READ = PREFIX + "-00035> : Configuration strategy with system property %s "
			+ "failed because there's no such property or file cannot be read.";
	String _00036_CONFIGURATION_FILE_NOT_FOUND = PREFIX + "-00036> : Configuration strategy with directory declared in system "
			+ "property %s results in a file (%s) that cannot be found.";
	...
	String _00096_CONFIGURATION_FILE_STRATEGY_FAILURE = PREFIX + "-00096> : Configuration strategy with file declared in system property %s fails "
			+ "because there's no such property or file cannot be read.";
